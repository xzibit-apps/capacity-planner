...
- **Writes:** `cp_*` tables only (`cp_projects`, `cp_staff`, `cp_curves`, `cp_curve_registry`, `cp_staff_leave`, `cp_company_closures`, `cp_sheet_projects`, `cp_rows`, `cp_job_types`, `cp_curve_libraries`)
